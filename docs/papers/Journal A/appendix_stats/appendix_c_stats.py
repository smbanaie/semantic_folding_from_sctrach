...
Reads per-query MRR from op_*/summary.json across datasets, computes:
  1. Bootstrap 95% CI (10,000 resamples)
  2. Paired Wilcoxon signed-rank test between operator pairs
  3. Holm-Bonferroni correction across all pairwise comparisons per dataset

Outputs: docs/papers/Journal A/appendix_stats/appendix_c_<dataset>.md
"""
import json
import numpy as np
