...
|---|:---:|:--:|:--------:|-----------------|
| 0.0 (SPLADE-only) | 0.797 | 0.537 | −11.5% | Lower than α=0.3 |
| **0.3** | **0.901** | **0.637** | **—** | **Optimal** |
| 0.5 | 0.850 | 0.620 | −5.7% | Degrading |
| 0.7 | 0.820 | 0.590 | −9.0% | Degrading |
| 1.0 (SF-only) | 0.788 | 0.537 | −12.5% | Worst |
...
| Dimensionality reduction | UMAP | Matches or beats t-SNE on 7/8 datasets |
...
2. **Generalizability**: The recommended configuration is based on tuning that may not generalize across all 8 datasets. Chapter 7 shows that dataset-specific parameters (e.g., t-SNE perplexity=30 for the MuSiQue v4 run) can improve performance.
